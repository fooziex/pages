...
?>
		...
		<form action="https://rootnode.net/pay/form.php" method="POST" name="form">
			<label for="first_name">User <strong><?php echo $user['user_name']; ?></strong></label>
			<div class="controls controls-row">
				<input type="text" id="first_name" name="first_name" class="span2" placeholder="First name"/>
				<input type="text" id="last_name"  name="last_name"  class="span2" placeholder="Last name"/>
			</div>
			<div class="controls controls-row">
				<input type="text" id="mail" name="mail" class="span4" placeholder="E-mail"/>
			</div>

			<label>Address</label>
			<div class="controls controls-row">
				<input type="text" class="span4" id="street" name="street" placeholder="Street"/>
			</div>
			<div class="controls controls-row">
				<input type="text" id="postcode" name="postcode" class="span2" placeholder="Postcode"/>
				<input type="text" id="city" name="city"   class="span2" placeholder="City"/>
			</div>
			<div class="controls controls-row">
			...
			<div class="controls">
				<select class="span2" name="fund" id="fund">
			...
			<label class="checkbox">
				<input type="checkbox" name="invoice" id="invoice"> I would like to get an invoice
			</label>
			<br/>
